...
<html lang="en">
  ...
  <input type="submit" class="logout" value="Log Out" />
      ...
      <wrapper class="messageBox">
        ...
        <p class="addFriends exit"  onclick="CopyToClipBoard()" id="myBtn"><img class="clipboard" src="assets/clipboard.png"></p>
...
function CopyToClipBoard() {
  var copyText = <?php echo "\"localhost/../message.php?code=".$code."\""; ?>;
 var newInput = $('<input>').val(copyText).appendTo('body').select()
